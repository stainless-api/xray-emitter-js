...
To publish a full release, visit [the public workflow](https://github.com/stainless-api/xray-emitter-js/actions/workflows/publish.yml) and run it manually with a version number like "0.2.0" (no "v" prefix).
